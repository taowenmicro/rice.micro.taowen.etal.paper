...
ps1 = ps0 %>% subset_samples.wt("species","1")
map = ps1 %>% sample_data()
head(map)
#-主题--颜色等
source("E:\\Shared_Folder\\Function_local\\R_function\\micro\\total_amplicon.R")
...
ps1 = ps0 %>% subset_samples.wt("species","2")
map = ps1 %>% sample_data()
head(map)
#-主题--颜色等
source("E:\\Shared_Folder\\Function_local\\R_function\\micro\\total_amplicon.R")
...
a = Sys.Date() %>% as.character()
a = gsub("-",".",a)
otupath = paste(res1path,"/Sub_OTU_2",a,"/",sep = "");otupath
dir.create(otupath)
...
ps1 = ps0 %>% subset_samples.wt("species","3")
map = ps1 %>% sample_data()
head(map)
#-主题--颜色等
source("E:\\Shared_Folder\\Function_local\\R_function\\micro\\total_amplicon.R")
...
a = Sys.Date() %>% as.character()
a = gsub("-",".",a)
otupath = paste(res1path,"/Sub_OTU_3",a,"/",sep = "");otupath
dir.create(otupath)
